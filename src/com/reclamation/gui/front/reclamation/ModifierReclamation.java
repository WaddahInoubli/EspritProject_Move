...
public class ModifierReclamation extends Form {
    ...
    private void addGUIs() {
        ...
        userTF.setText(String.valueOf(currentReclamation.getUser()));
        objectifTF.setText(currentReclamation.getObjectif());
        textTF.setText(currentReclamation.getText());
        etatTF.setText(String.valueOf(currentReclamation.getEtat()));
