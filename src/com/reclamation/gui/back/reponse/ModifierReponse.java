...
public class ModifierReponse extends Form {
    ...
    private void addGUIs() {
        ...
        reclamationTF.setText(String.valueOf(currentReponse.getReclamation()));
        objectifTF.setText(currentReponse.getObjectif());
        texteTF.setText(currentReponse.getTexte());
        userTF.setText(String.valueOf(currentReponse.getUser()));
    ...
    private void addActions() {
        ...
        manageButton.addActionListener(action -> {
            if (controleDeSaisie()) {
                ...
                if (responseCode == 200) {
                    AlertUtils.makeNotification("Reponse modifié avec succes");
                    showBackAndRefresh();
                } else {
