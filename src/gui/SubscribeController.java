...
public class SubscribeController implements Initializable {
    ...
    private void signup(ActionEvent event) throws IOException, SQLException {
        if(controleDeSaisie()){
            User user=new User(nom.getText(), prenom.getText(), Integer.parseInt(age.getText()), adresse.getText(), numT.getText(), mail.getText(), "CLIENT", password1.getText(), Boolean.TRUE);
