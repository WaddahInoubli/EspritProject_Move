...
class __TwigTemplate_fe6af137102fba33e11cc6f50a47858b3870716d99a3ee5a2f7c136a85188a6d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["reclamations"]) || array_key_exists("reclamations", $context) ? $context["reclamations"] : (function () { throw new RuntimeError('Variable "reclamations" does not exist.', 27, $this->source); })()));
...
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 29
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "id", [], "any", false, false, false, 29), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "objectif", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 31
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "text", [], "any", false, false, false, 31), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 32
...
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 34
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_show", ["id" => twig_get_attribute($this->env, $this->source, $context["reclamation"], "id", [], "any", false, false, false, 34)]), "html", null, true);
            echo "\">show</a>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["reclamation"], "id", [], "any", false, false, false, 35)]), "html", null, true);
            echo "\">delete</a>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 36
...
";
    ...
    {
        return array (  171 => 51,  162 => 44,  153 => 40,  144 => 36,  140 => 35,  136 => 34,  131 => 32,  127 => 31,  123 => 30,  119 => 29,  116 => 28,  111 => 27,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t
{% endblock %}
", "reclamation/index.html.twig", "C:\\Users\\HP\\pidev1\\templates\\reclamation\\index.html.twig");
    }
}
